...
type ClientResponseMessageUnion = DeleteSubscriptionResponseMessage | GetMigrateResponseMessage | PostMigrateResponseMessage | PostSubscriptionResponseMessage;
export type ClientResponseMessage<T> = Extract<ClientResponseMessageUnion, {
    key: T;
}>;
export {};
