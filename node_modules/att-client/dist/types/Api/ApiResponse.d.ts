...
import type { GroupInfo, GroupMemberInfo, InvitedGroupInfo, JoinedGroupInfo, ServerConnectionInfo, ServerInfo } from './schemas/index.js';
...
type ApiResponseUnion = AcceptGroupInviteResponse | GroupInfoResponse | GroupInvitesResponse | GroupMemberResponse | JoinedGroupsResponse | ServerConnectionDetailsResponse | ServerInfoResponse;
type ApiResponseBody<TMethod, TEndpoint> = Extract<ApiResponseUnion, {
    method: TMethod;
    endpoint: TEndpoint;
}>['body'];
